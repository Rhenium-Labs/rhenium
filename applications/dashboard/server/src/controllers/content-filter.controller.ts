...
import { ContentFilterConfigUpdateSchema, ChannelScopingUpdateSchema } from '../services/schemas/content-filter.schema'
import type { ContentFilterService } from '../services/content-filter.service'
import type { RouterFn, GuildProcedureBuilder, GuildWriteProcedureBuilder } from '../procedures'

export function createContentFilterController(
    router: RouterFn,
