...
> {
	...
	/**
	 * `prisma.unbanJob`: Exposes CRUD operations for the **UnbanJob** model.
	 * Example usage:
	 * ```ts
	 * // Fetch zero or more UnbanJobs
	 * const unbanJobs = await prisma.unbanJob.findMany()
	 * ```
	 */
	get unbanJob(): Prisma.UnbanJobDelegate<ExtArgs, { omit: OmitOpts }>;
}
